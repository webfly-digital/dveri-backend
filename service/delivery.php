...
$APPLICATION->SetTitle("Доставка и оплата (Москва и область)");
?>

    <div class="text-content">
        <p class="subtitle">Компания Двери Металл-М организует доставку заказа на указанный адрес по Москве и за пределы МКАД. Оформление доставки происходит после подтверждения заказа менеджером и
            согласования стоимости и сроков. Совместно с клиентом подбирается удобная дата и время привоза. Доставляются заказы любых объемов. Стоимость составляет от 4500 рублей в зависимости от
            объема заказа и расстояния для транспортировки.</p>
    </div>

    <!--Оплата и предоплата-->
    <section class="page-section">
        <p class="h2 page-section__title">Оплата и предоплата</p>
        <p class="subtitle">Внести оплату за заказ необходимо после заключения договора о поставке. Оплатить заказ возможно любым удобным способом:</p>
        <div class="text-content">
            <!--Варианты оплаты-->
            ...
            <p>При безналичной оплате предоплата составляет 100%. При заказе крупной партии предоставляются индивидуальные условия оплаты! Обратитесь к менеджеру компании, чтобы узнать больше об
                индивидуальных предложениях и согласовать поставки.</p>

            <h3>Порядок оплаты при наличном расчете</h3>
            <p>Заключается договор на производство и поставку противопожарной продукции. После заключения договора необходимо внести указанную сумму. Произвести оплату возможно через сотрудников
                компании. После оплаты на руки выдается квитанция.</p>

            <h3>Порядок оплаты при безналичном расчете</h3>
            <p>Заключается договор на производство и поставку продукции. Покупателю отправляется счет для оплаты любым удобным способом — электронная почта, почтовое отправление, факс и прочее.
                Необходимо внести всю указанную сумму сразу.</p>
    ...
    <section class="page-section">
        ...
        <div class="text-content">
            <p class="subtitle">Доставка заказа по Москве и за пределы МКАД осуществляется транспортной компанией «Деловые Линии». Возможно оформление доставки до терминала или непосредственно на
                адрес объекта.</p>
            <p>Выбрать ближайший удобный терминал можно на этой странице:</p>
            ...
            <p>Перед оформлением заказа также возможен бесплатный вызов замерщика. Для приглашения специалистов заполните специальную форму или свяжитесь с менеджером, чтобы выбрать удобное время для
                посещения замерщика. После согласования специалисты компании Двери Металл-М посетят объект и проведут замеры.</p>
            <p>
    ...
    <section class="page-section">
        ...
        <div class="text-content">
            <p class="subtitle">Доставка заказанных товаров организуется после поступления оплаты за покупку. Стоимость доставки зависит от объема заказа и удаленности объекта. Средняя стоимость
                доставки по Москве и в пределах 30 км от МКАД</p>

            <ul class="">
                <li>от 4500 рублей при заказе 1-5 позиций,</li>
                <li>от 5000 рублей при заказе 5-10 позиций,</li>
                <li>от 7000 рублей при заказе 10-13 позиций,</li>
                <li>от 9000 рублей при заказе 14-20 позиций.</li>
            </ul>

            <p>Дата и время доставки согласовываются по факту готовности продукции или при формировании заказа.</p>
        </div>
    </section>
    <!--/условия доставки-->
    ...
    <section class="page-section">
        ...
        <div class="text-content">
            <p class="subtitle">Приглашаем вас детальнее ознакомиться с процессом производства нашей продукции</p>
