...
?>
          ...
          <div class="text-content">
            <p class="subtitle">Компания Двери Металл-М предлагает доставку заказов в пределах Центрального региона, а также в другие регионы России по согласованию. Стоимость и срок доставки обсуждается с менеджером при оформлении заказа. Дата и время доставки подбираются совместно с клиентом. Возможна доставка любых объемов продукции на объект. Цена зависит от расстояния перевозки и объема партии.</p>
          </div>
          <!--Оплата и предоплата-->
...
<!--/варианты оплаты-->
              ...
              <p>Заключается договор на производство и поставку противопожарных изделий. Необходимо произвести оплату в срок, установленный договором. Внести деньги возможно через сотрудников компании. Для заказов из регионов вся сумма вносится сразу.</p>

              <h3>Порядок оплаты при безналичном расчете</h3>
              <p>Заключается договор на производство и поставку изделий. Сотрудник компании подготовит и выставит счет, по которому необходимо произвести оплату. Счет может быть отправлен клиенту любым удобным способом — факс, электронная почта, почтовое отправление и прочее. Для начала производства должна быть внесена полная стоимость заказа.</p>

              <div class="gal gal-v4">
                <div class="gal-item">
                  <a href="/bitrix/templates/1dvm/img/doc-examples/doc-1.jpg" class="gal-item__preview"><img alt="" class="lazyload"
                                                                                       data-original="/bitrix/templates/1dvm/img/doc-examples/preview/doc-1.jpg"></a>
                </div>
                <div class="gal-item">
                  <a href="/bitrix/templates/1dvm/img/doc-examples/doc-2.jpg" class="gal-item__preview"><img alt="" class="lazyload"
                                                                                       data-original="/bitrix/templates/1dvm/img/doc-examples/preview/doc-2.jpg"></a>
                </div>
                <div class="gal-item">
                  <a href="/bitrix/templates/1dvm/img/doc-examples/doc-3.jpg" class="gal-item__preview"><img alt="" class="lazyload"
                                                                                       data-original="/bitrix/templates/1dvm/img/doc-examples/preview/doc-3.jpg"></a>
                </div>
              </div>
          ...
          <section class="page-section">
            ...
            <div class="text-content">
              <p class="subtitle">Доставка в регионы осуществляется при помощи транспортной компании «Деловые Линии». Возможно оформление доставки до удобного терминала в городе получателя или непосредственно на адрес объекта.</p>
          ...
          <section class="page-section">
            ...
            <div class="text-content">
              <p class="subtitle">Упаковка и погрузка товара начинаются после получения оплаты заказа. Стоимость доставки зависит от объема продукции и города получателя. Средняя стоимость составляет:</p>
              ...
              <p>Точную стоимость доставки в город получателя уточняйте у менеджера при оформлении заказа или у консультантов на горячей линии. Дата доставки согласовывается с клиентом по факту готовности заказа или при оформлении покупки.</p>
            </div>
          </section>
          <!--/условия доставки-->
...
<div class="gal gal-v2">
  <div class="gal-item">
    <a href="/bitrix/templates/1dvm/img/gal/04.jpg" class="gal-item__preview lazyload" title="Подпись к фотке 4"
       data-original="/bitrix/templates/1dvm/img/gal/04.jpg"></a>
  </div>
  <div class="gal-item">
    <a href="/bitrix/templates/1dvm/img/gal/07.jpg" class="gal-item__preview lazyload" title="Подпись к фотке 7"
       data-original="/bitrix/templates/1dvm/img/gal/07.jpg"></a>
  </div>
  <div class="gal-item">
    <a href="/bitrix/templates/1dvm/img/gal/08.jpg" class="gal-item__preview lazyload" title="Подпись к фотке 8"
       data-original="/bitrix/templates/1dvm/img/gal/08.jpg"></a>
  </div>
</div>
<!--/gallery-->
