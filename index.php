                    ...
                    <div class="gal-item">
                        <a href="<?= $cert["PATH"] ?>" class="gal-item__preview">
                            <img alt="<?= $cert_desc ?>" title="<?= $cert_desc ?>"
                                 src="<?= ImageCompressor::getCompressedSrcUniversal($cert['PATH']) ?>">
                        </a>
                    </div>
                <?php endforeach ?>
            </div>
            ...
            <?php if ($gallery6): ?>
                <div class="square-pics">
                    <?php foreach ($gallery6 as $minigal): ?>
                        <div class="pic" style="background-image: url('<?= ImageCompressor::getCompressedSrcUniversal($minigal["PATH"]) ?>');"></div>
                    <?php endforeach ?>
                </div>
            <?php endif ?>
        </div>
