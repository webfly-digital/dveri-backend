			...
			<div class="vis-card">
				<div class="vis-card__content">
					<div class="vis-card__pic">
						...
						<h3 class="vis-card__title text--sky">Собственное производство</h3>
			...
			<div class="vis-card">
				<div class="vis-card__content">
					<div class="vis-card__pic">
						...
						<h3 class="vis-card__title text--sky">Гибкое ценообразование</h3>
						<p class="vis-card__descr">
			...
			<div class="vis-card">
				<div class="vis-card__content">
					<div class="vis-card__pic">
						...
						<h3 class="vis-card__title text--sky">Широкий ассортимент</h3>
						<p class="vis-card__descr">
			...
			<div class="vis-card">
				<div class="vis-card__content">
					<div class="vis-card__pic">
						...
						<h3 class="vis-card__title text--sky">Надежность конструкций</h3>
						<p class="vis-card__descr">
			...
			<div class="vis-card">
				<div class="vis-card__content">
					<div class="vis-card__pic">
						...
						<h3 class="vis-card__title text--sky">Гарантия качества продукции</h3>
						<p class="vis-card__descr">
			...
			<div class="vis-card">
				<div class="vis-card__content">
					<div class="vis-card__pic">
						...
						<h3 class="vis-card__title text--sky">Расчет стоимости по звонку</h3>
						<p class="vis-card__descr">
			...
			<div class="vis-card">
				<div class="vis-card__content">
					<div class="vis-card__pic">
						...
						<h3 class="vis-card__title text--sky">Профессиональный монтаж</h3>
						<p class="vis-card__descr">
			...
			<div class="vis-card">
				<div class="vis-card__content">
					<div class="vis-card__pic">
						...
						<h3 class="vis-card__title text--sky">Оперативная доставка</h3>
						<p class="vis-card__descr">
