...
<?
// is valid ?
$valid = (($_POST["ajaxm"] == "Y") and check_bitrix_sessid() and (substr_count($_SERVER['HTTP_REFERER'],"catalog") > 0));
$name = htmlentities($_POST['name']);
$email = htmlentities($_POST['email']);
$phone = htmlentities($_POST['phone']);
$comment = htmlentities($_POST['message']);
$url = '<a href="'.$_SERVER['HTTP_REFERER'].'">Ссылка на товар</a>';
$ordername = "ЗАЯВКА";
...
define('CRM_PASSWORD', 'SaM612505'); // пароль пользователя CRM
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $postData = array(
            ...
            'ASSIGNED_BY_ID' => '3216',
            'SOURCE_ID' => 'WEB',
            'COMMENTS' => "Сайт: $site<br/>Форма: $ordername<br/>Имя: $name<br/>Телефон: $phone<br/>E-mail: $email<br/>Дата: ".date("d.m.Y H:i")."<br/>$url<br/>Комментарий: $comment"
        );
