...
{
	if ($configItem['name'] !== 'BOX_SECTION') { continue; }
...
$arResult['EDITOR']['ENTITY_DATA']['BASKET_CONFIRM'] = [
	'ITEMS_CHANGE_REASON' => !empty($arResult['ITEMS_CHANGE_REASON']) ? $arResult['ITEMS_CHANGE_REASON'] : [],
];

$arResult['JS_MESSAGES']['BasketConfirm'] = [
	'MODAL_TITLE' =>
		!empty($arResult['ITEMS_CHANGE_REASON'])
			? Loc::getMessage('YANDEX_MARKET_T_TRADING_ORDER_VIEW_BASKET_CONFIRM_MODAL_TITLE_WITH_REASON')
			: Loc::getMessage('YANDEX_MARKET_T_TRADING_ORDER_VIEW_BASKET_CONFIRM_MODAL_TITLE'),
