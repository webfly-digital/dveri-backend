...
class CrmMarketplaceMenu extends \CBitrixComponent
{
	...
	protected function feedbackUrl()
	{
		...
		if ($business !== null)
		{
			return sprintf('https://partner.market.yandex.ru/business/%s/support', (int)$business['ID']);
		}

		return 'https://marketplace.1c-bitrix.ru/solutions/yandex.market/#tab-support-link';
	}
