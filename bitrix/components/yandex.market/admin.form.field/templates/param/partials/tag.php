...
foreach ($tagValues as $tagValue)
{
	...
	?>
	<div class="b-param-tag <?= $tag->hasChildren() || $tag->hasAttributes() ? 'is--parent' : '' ?> <?= $isTagPlaceholder && ($tagLevel === 0 || !$isPersistent) ? 'is--hidden' : '' ?> js-param-tag-collection__item level--<?= $tagLevel ?>" <?= Attributes::stringify([
