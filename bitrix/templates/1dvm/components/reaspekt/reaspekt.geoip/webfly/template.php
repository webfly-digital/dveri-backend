...
<?if($arResult["GEO_CITY"]):
    ...
    if ($arResult["SET_LOCAL_DB"] == "local_db") :?>
        <div class="wrapGeoIpReaspekt">
            <?=GetMessage("REASPEKT_GEOIP_TITLE_YOU_CITY");?> <span data-reaspektmodalbox-href="<?=$templateFolder?>/ajax_popup_city.php" class="cityLinkPopupReaspekt linkReaspekt"><?=$arResult["GEO_CITY"]["CITY"]?></span>
            <?if (
