...
Город: <a href="#modalCities" id="wf-city" class="link-dashed"><?=$arResult["CURRENT_CITY"]["NAME"]?></a>
<div id="modalCities" class="wf-modal-cities wf-modal fade">
    <div class="wf-modal-dialog modal-lg">
        <div class="wf-modal-content">
            <div class="wf-modal-header">
                <p class="wf-modal-title"><?=GetMessage("WF_CHOOSE_YOUR_CITY")?></p>
                <a href="#" class="wf-modal-close" title="<?=GetMessage("WF_CLOSE")?>">
                  <span class="icomoon icon-cancel-music"></span>
                </a>
            </div>
