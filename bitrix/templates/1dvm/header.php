        ...
        <div class="h-supertop__path">
            <ul class="list-inline">
                <li>
                    ...
                    <div><?
                        $APPLICATION->IncludeComponent(
                            "webfly:cities.popup", "popup", array(
                ...
                <li>
                    ...
                    <a href="#" class="btn btn--sky btn--sm modal-universal-button"
                        <? //      href="#modalUniversal"   data-options="Получить прайс-лист|.input-comment|PRICE_GOAL"?>
                            ...
                            <p class="contact__info hidden-affix">
                                ...
                                <a href="#"
                                   class="modal-universal-button"
                                    <? // href="#modalUniversal"  data-options="Обратный звонок|.input-email,.input-comment|CALLBACK_GOAL"?>
                                ><b>Обратный
                                        звонок</b></a></p>
                        </div>
                    </div>
                    ...
                    <div class="h-top__buttons">
                        ...
                        <a href="#" class="btn btn--sm btn--gray modal-universal-button"
                           style="line-height: 30px;    background-color: #f24840"
                            <? // href="#modalUniversal" data-options="Вызвать замерщика|.input-comment|GAGER_GOAL"?>
                        >
...
<div id="maincontent">
    <? if (CSite::InDir('/catalog/')) { ?>
        <div class="advantages-wrapper">
            <div class="container">
                <? $APPLICATION->IncludeFile("/include/seo.php", [], ["MODE" => "php", "NAME" => "seo",]); ?>
            </div>
        </div>
    <? } ?>
    <? if ($dirInfo["DIR"] !== SITE_DIR): ?>
